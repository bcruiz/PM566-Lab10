...
| customer\_id | first\_name | last\_name | payment\_id | amount |
| -----------: | :---------- | :--------- | ----------: | -----: |
|            6 | JENNIFER    | DAVIS      |       16685 |   4.99 |
|            6 | JENNIFER    | DAVIS      |       16686 |   2.99 |
|            6 | JENNIFER    | DAVIS      |       16687 |   0.99 |
...
SELECT MAX(amount) AS MaxAmount, MIN(amount) AS MinAmount,
  AVG(amount) AS AvgAmount, SUM(amount) AS SumAmount
FROM payment
```
...
``` sql
SELECT customer_id, MAX(amount) AS MaxAmount, MIN(amount) AS MinAmount,
  AVG(amount) AS AvgAmount, SUM(amount) AS SumAmount
FROM payment
GROUP BY customer_id
```
...
| customer\_id | MaxAmount | MinAmount | AvgAmount | SumAmount |
| -----------: | --------: | --------: | --------: | --------: |
...
``` sql
SELECT customer_id, MAX(amount) AS MaxAmount, MIN(amount) AS MinAmount,
  AVG(amount) AS AvgAmount, SUM(amount) AS SumAmount, COUNT(*) AS count
FROM payment
GROUP BY customer_id
HAVING COUNT(*) > 5
```
...
| customer\_id | MaxAmount | MinAmount | AvgAmount | SumAmount | count |
| -----------: | --------: | --------: | --------: | --------: | ----: |
